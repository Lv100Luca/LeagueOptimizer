...
//         };
//
//         var perLevelStat = StatsCalculator.CalculateStat(Level.From(level), statData);
//
...
//
//         var perLevelStat = StatsCalculator.CalculateStat(level, statData);
//
//         Assert.That(perLevelStat.Total, Is.EqualTo(expectedValue).Within(0.1m));
//     }
//
...
//         };
//
//         IAttackSpeed attackSpeed = new AttackSpeed(StatsCalculator.CalculatePerLevelBonusAttackSpeed(level, growth))
//             { Bonus = bonusAttackSpeed };
//
//         attackSpeed = StatsCalculator.UpdateAttackSpeed(level, attackSpeed, statData);
//
